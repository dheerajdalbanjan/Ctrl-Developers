...
const Hero = () => {
    return (
        <div className='flex flex-col space-y-4 text-primary px-4 py-8 xl:mx-auto max-w-7xl'>
            ...
            <div className='flex items-center w-full sm:justify-start sm:space-x-5 justify-between'>
                <div className='w-fit flex items-center space-x-1 '>
                    <span className='text-base sm:text-xl sm:p-2 sm:w-[22rem] text-wrap uppercase w-[17rem] p-1  bg-secondary '>A creative WEB design AND DEVELOPMENT AGENCY from INDIA</span>
                    <span className='h-14 sm:h-[4.5rem] w-5 sm:w-10 bg-secondary'></span>
                    <span className='h-14 sm:h-[4.5rem] w-2 sm:w-6 bg-secondary'></span>
                </div>
